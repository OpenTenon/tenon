...
def ics55_geometry(profile: dict, ics55: dict, variant: dict) -> dict[str, float | bool]:
    ...
    # The existing VDD25/VSSD rings occupy the 250 um and 300 um corridors.
    if compact and core_offset < 365.0:
        raise ValueError(f"{profile['id']} {variant['id']}: compact core offset overlaps IO PDN")
    return {
        "compact": compact,
        "die_side": die_side,
