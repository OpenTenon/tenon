...
For the compact ICS55 QFN32 `no-pll` reference, the generated floorplan is a 960 x 960 um die with a 230 x 230 um core. It uses the commercial 30 um PB4/PVSS1/PVDD2/PVSS2 and 35 um PVDD1 pitch, fixed PADI30/PADO30 overlay offsets, PCORNER cells, and the commercial PFILL family to close every edge. This is a validated non-signoff reference run: Magic/KLayout DRC, Magic Spice extraction and Netgen LVS were explicitly skipped, while OpenROAD route DRC, antenna, PSM and disconnected-pin checks completed.
