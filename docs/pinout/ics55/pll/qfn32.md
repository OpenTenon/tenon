...
| P11 | east | 3 | PLL_AVSS | ground | PVSS1CAP | pll_avss |
| P12 | east | 4 | PLL_AVDD | power | PVDD1CAP | pll_avdd |
| P13 | east | 5 | VSS | ground | PVSS1 | VSS |
| P14 | east | 6 | GPIO | inout | PB4 | gpio[4] |
| P15 | east | 7 | jtag_tms | input | PB4 | jtag_tms_i |
| P16 | east | 8 | GPIO | inout | PB4 | gpio[5] |
| P17 | north | 1 | IOVDD | power | PVDD2 | IOVDD |
| P18 | north | 2 | jtag_tdi | input | PB4 | jtag_tdi_i |
| P19 | north | 3 | XIN | inout | PXWE1 | pll_xin_pad |
| P20 | north | 4 | XOUT | inout | PXWE1 | pll_xout_pad |
| P21 | north | 5 | IOVSS | ground | PVSS2 | IOVSS |
| P22 | north | 6 | AVSSIO | ground | PVSS3AP | pll_avssio |
| P23 | north | 7 | jtag_tdo | output | PB4 | jtag_tdo_o |
| P24 | north | 8 | AVDDIO | power | PVDD3AP | pll_avddio |
| P25 | west | 1 | VDD | power | PVDD1 | VDD |
| P26 | west | 2 | uart_rx | input | PB4 | uart_rx_i |
| P27 | west | 3 | GPIO | inout | PB4 | gpio[6] |
| P28 | west | 4 | GPIO | inout | PB4 | gpio[7] |
| P29 | west | 5 | VSS | ground | PVSS1 | VSS |
| P30 | west | 6 | GPIO | inout | PB4 | gpio[8] |
| P31 | west | 7 | uart_tx | output | PB4 | uart_tx_o |
| P32 | west | 8 | GPIO | inout | PB4 | gpio[9] |
