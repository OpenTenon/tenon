...
# GF180MCU D Tier0 core PDN. DVDD/DVSS remain a separate IO pad-ring domain.
...
add_pdn_connect \
    -grid stdcell_grid \
    -layers "$::env(PDN_CORE_VERTICAL_LAYER) $::env(PDN_CORE_HORIZONTAL_LAYER)"
# The GF180 standard-cell rails terminate on Metal1/Metal2. These bridges
# connect the core ring to that rail network, matching the local GF180 flow.
add_pdn_connect \
    -grid stdcell_grid \
