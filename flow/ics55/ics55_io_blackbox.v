...
module PB4 (VSSD, VSS, PAD, OEN, C, IE, I, VDD25, VDD, FP, FPB);
  inout VSSD, VSS, PAD, VDD25, VDD, FP, FPB;
  input OEN, IE, I;
  output C;
endmodule

module PVDD1 (VDD25, VSS, VDD, VSSD, FP, FPB);
  inout VDD25, VSS, VDD, VSSD, FP, FPB;
endmodule
module PVSS1 (VSSD, VSS, VDD25, VDD, FPB, FP);
  inout VSSD, VSS, VDD25, VDD, FPB, FP;
endmodule
module PVDD2 (VDD25, VDD, FP, FPB, VSS, VSSD);
  inout VDD25, VDD, FP, FPB, VSS, VSSD;
endmodule
module PVSS2 (VDD25, FP, FPB, VDD, VSSD, VSS);
  inout VDD25, FP, FPB, VDD, VSSD, VSS;
endmodule

module PVDD1CAP (SVDD1CAP); inout SVDD1CAP; endmodule
module PVSS1CAP (SVSS1CAP); inout SVSS1CAP; endmodule
module PVDD3AP (SAVDD); inout SAVDD; endmodule
module PVSS3AP (SAVSS); inout SAVSS; endmodule
...
module PLL_TOP (
    BP, CKOUT1, CKOUT2, CKTST, EN, N, OD, REFCLK, SELECT,
    AVDD, AVSS, DVDD, DVDD_DRV, DVSS, DVSS_DRV
);
