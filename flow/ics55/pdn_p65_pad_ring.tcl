...
# Native P65 package-ring bridges. Every VDD/VSS contact originates at an
# actual MET5 rectangle retained from the commercial P65 LEF abstraction.
# VDDIO/VSSIO remain inside the native P65 pad row and receive no generated ring.
...
proc tenon_ics55_p65_add_transition {swire tech net_name x y} {
    if {$net_name eq "vdd"} {
        ...
        error "No generated P65 package-ring bridge is allowed for $net_name"
    }
}
...
proc tenon_ics55_p65_ring_layer {tech net_name} {
    ...
    error "Unknown P65 package-ring net $net_name"
}
