...
def main() -> None:
    ...
    files = {
        ...
        "std_lef": source / "lef" / "ics55_LLSC_H7CR_M2.lef",
        "std_gds": source / "gds" / "ics55_LLSC_H7CR_M2.gds",
        "std_cdl": source / "cdl" / "ics55_LLSC_H7CR.cdl",
        "std_tt": source / "ccslib" / "ics55_LLSC_H7CR_typ_tt_1p2_25_nldm.lib",
        "std_ss": source / "ccslib" / "ics55_LLSC_H7CR_ss_rcworst_1p08_125_nldm.lib",
        "std_ff": source / "ccslib" / "ics55_LLSC_H7CR_ff_rcbest_1p32_m40_nldm.lib",
    ...
    write_text(
        destination / "libs.tech" / "magic" / "ics55.tech",
        make_magic_tech(),
    )
    write_text(
        destination / "libs.tech" / "magic" / "ics55.magicrc",
        make_magicrc(),
    )
    write_text(
